=== Enter Checkout Page ===
Contributors:
Tags: enter, woocommerce, payment-gateway, checkout, commerce, credit-card
...
A Payment Gateway for WooCommerce allowing you to take credit card payments using Enter.

== Description ==

Welcome to Enter Checkout. Enter Checkout is an implementation of Enter Connect API to provide users with a
streamlined, mobile-ready payment experience that is constantly improving without you doing any work.

= Get Started =

Sign up for a merchant account by opening your Enter account settings and changing Individual Account to Business
Account and following the wizard that shows. Then, visit http://docs.enter.financial/docs/woocommerce for installation
instructions.
...
In the search field type “Enter Checkout Page” and click Search Plugins. Once you've found our plugin you can view
...
Simply go to our [Sandbox](https://login.sandbox.enter.financial/?i=wallet&r=/#/app/register) and register. Our sandbox
...
Under Enter Checkout, click Edit Checkout configuration. There you'll find your Checkout ID and, once you set your
Callback URL, your Callback Secret.

= Do I need to have an SSL Certificate? =
Yes. The transactions complete asynchronously. This means that Enter servers will contact your servers to let them know
the status of a transaction (e.g. executed, error, etc.). This communication happens over SSL.

== Screenshots ==

1. The Enter button in action
...
* Adding order note recording the Enter transfer ID
